 ...
 * @author vpc
 */
public class PangaeaNoteContentType {
    ...
    public PangaeaNoteContentType(String major, String minor, String charset, String editor, Map<String, String> properties) {
        this.major = major;
        this.minor = minor;
        this.editor = editor;
    ...
    public static PangaeaNoteContentType of(String s) {
        return of(s,true);
    }
    
    public static PangaeaNoteContentType of(String s, boolean lenient) {
        if (s != null && s.length() > 0) {
            ...
            if (a.length > 0) {
                ...
                if (b.length == 2) {
                    ...
                    return new PangaeaNoteContentType(b[0], b[1], charset, editor, p);
                }
            } else {
                if (lenient) {
                    return null;
    ...
    public boolean equals(Object obj) {
        ...
        final PangaeaNoteContentType other = (PangaeaNoteContentType) obj;
