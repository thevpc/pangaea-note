...
class PangaeaNoteFieldDescriptorPanel {
    ...
    private FormComponent createFormComponent(PangaeaNoteFieldType t) {
        switch (t) {
            case TEXT: {
                return new TextFieldComponent(sapp);
            }
            case PASSWORD: {
                return new PasswordComponent(sapp);
            }
            case URL: {
    ...
    public void setValue(PangaeaNoteField field, PangaeaNoteObject object, PangageaNoteObjectDocument document) {
        this.field = field;
        this.object = object;
    ...
    public void onDescriptorEditValues() {
        if (document != null) {
            ...
            AppDialogResult s = sapp.newDialog()
    ...
    public void onDescriptorRename() {
        if (document != null) {
            AppDialogResult r = sapp.newDialog()
                    .withOkCancelButtons()
