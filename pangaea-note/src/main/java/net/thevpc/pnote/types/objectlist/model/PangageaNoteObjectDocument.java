 ...
 * @author vpc
 */
public class PangageaNoteObjectDocument {
    ...
    public PangageaNoteObjectDocument setDescriptor(PangaeaNoteObjectDescriptor descriptor) {
    ...
    public PangageaNoteObjectDocument addValue(PangaeaNoteObject value) {
        if (values == null) {
    ...
    public PangageaNoteObjectDocument setValues(List<PangaeaNoteObject> values) {
        this.values = values;
        return this;
    }
