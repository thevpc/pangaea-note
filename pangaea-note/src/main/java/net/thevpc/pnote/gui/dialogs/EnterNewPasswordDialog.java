...
public class EnterNewPasswordDialog extends OkCancelDialog {
    ...
    public EnterNewPasswordDialog(PangaeaNoteWindow sapp, String path, PasswordHandler ph) throws HeadlessException {
        super(sapp, "Message.password");
        this.ph=ph;
        passwordComponent1 = new PasswordComponent(sapp);
        passwordComponent1.install(sapp.app());
        passwordComponent1.setMinimumSize(new Dimension(50, 30));
        passwordComponent2 = new PasswordComponent(sapp);
