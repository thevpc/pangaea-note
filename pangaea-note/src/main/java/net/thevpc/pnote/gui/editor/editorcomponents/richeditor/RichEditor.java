 ...
 */
package net.thevpc.pnote.gui.editor.editorcomponents.richeditor;
 ...
 * @author vpc
 */
public class RichEditor extends JPanel implements PNoteEditorTypeComponent {
...
//                System.out.println("update note:" + editorBuilder.editor().getText());
    ...
    public RichEditor(boolean compactMode, PangaeaNoteGuiApp sapp) {
