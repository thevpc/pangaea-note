 ...
 */
package net.thevpc.pnote.gui.editor.editorcomponents.notelist;
    ...
    public void onAddObjectAt(int pos) {
        if (currentNote != null) {
            if (currentNote.getChildren().size() > 0) {
                ...
                currentNote.addChild(pos, PangaeaNoteExt.of(new PangaeaNote().setContentType(PangaeaNoteTypes.PLAIN)));
            }
