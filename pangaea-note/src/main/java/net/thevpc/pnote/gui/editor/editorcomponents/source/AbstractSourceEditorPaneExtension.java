...
//            SwingApplicationUtils.registerButton(insertMenu, null, "$Action." + id+".icon", app);
...
//                    }
//                    insertMenu.add(SwingApplicationUtils.registerAction(a, messageId, iconId, app));
//                }
//            }
//            bar.add(insertMenu);
//        }
...
//            SwingApplicationUtils.registerButton(insertMenu, "Action."+id, "$Action."+id+".icon", app);
//            for (ActionInfo actionInfo : sub) {
//                if (actionInfo == null) {
//                    insertMenu.addSeparator();
//                } else {
...
//        SwingApplicationUtils.unregisterAction(a, context.app());
//        return a;
//    }
//
//    public Action prepareAction(String id, Action a, Context context) {
//        SwingApplicationUtils.registerAction(a, "Action." + id, "$Action." + id + ".icon", context.app());
//        context.add(a);
//        return a;
//    }
//
...
//
//        public Context(PangaeaNoteFrame win, JEditorPane pane) {
//            this.win = win;
//            this.app = win.app();
//            this.pane = pane;
//        }
