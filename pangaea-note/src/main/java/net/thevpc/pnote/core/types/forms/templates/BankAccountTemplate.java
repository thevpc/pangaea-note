...
public class BankAccountTemplate extends AbstractPangaeaNoteTemplate {
    ...
    public void prepare(PangaeaNote n, PangaeaNoteService win) {
        ...
        PangaeaNoteObjectDocument doc = new PangaeaNoteObjectDocument().setDescriptor(new PangaeaNoteObjectDescriptor()
                ...
                .addField(new PangaeaNoteFieldDescriptor().setName(str("agency", win)).setType(PangaeaNoteFieldType.TEXT))
                .addField(new PangaeaNoteFieldDescriptor().setName(str("agencyAddress", win)).setType(PangaeaNoteFieldType.TEXT))
                .addField(new PangaeaNoteFieldDescriptor().setName(str("rib", win)).setType(PangaeaNoteFieldType.TEXT))
                .addField(new PangaeaNoteFieldDescriptor().setName(str("iban", win)).setType(PangaeaNoteFieldType.TEXT))
